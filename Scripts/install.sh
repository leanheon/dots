...
EOF
    ...
    # Run HyDE-Caelestia UI replacement and integration script
    print_log -g "[integrate] " "UI replacement :: " "Running HyDE-Caelestia UI replacement and integration script..."
    "${scrDir}/../Integration/post_install.sh"
